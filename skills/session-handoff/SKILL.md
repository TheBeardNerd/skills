...
2. Set `SKILL_DIR="${SKILL_DIR:-$HOME/.agents/skills/session-handoff}"`.
...
1. Set `SKILL_DIR="${SKILL_DIR:-$HOME/.agents/skills/session-handoff}"`.
...
After substantial work, suggest creating a handoff. Do not create one automatically without user intent.
